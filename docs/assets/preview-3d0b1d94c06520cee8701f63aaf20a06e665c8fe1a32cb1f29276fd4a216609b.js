...
var Dropdown = function (_Component) {
    ...
    _createClass$1(Dropdown, [{
        ...
        value: function initialize(options) {
            ...
            this.options = $.extend(this.options, undefined(options, Object.keys(this.options)));
...
$(document).ready(function () {
    ...
    $.fn.uniformDropdown = function () {
        return this.each(function () {
            ...
            if (el.data('dropdown-content') !== undefined) options.content = "<div class='" + UniformComponent$1.namespace + "pad'>" + el.data('dropdown-content') + "</div>";
