...
export default class Select extends Component {
    ...
    toggleOptions (e) {
        ...
        if(this.el.classList.contains('active')){
            ...
            this.uniformPopover.toggle(false)
        }
    }
    ...
    renderOptions () {
        ...
        this.uniformPopover = new Popover({
            offset: {top: 1},
            align: '0px bottom',
            anchor: this.el,
            content: options,
        ...
        this.listenTo(this.uniformPopover, 'hidden', this.removeOptions);
    }
    
    removeOptions () {
        this.el.classList.remove('active')
        if (!this.uniformPopover) return;
        this.uniformPopover.remove()
    }
    ...
    showAllOptions (e) {
        ...
        e.stopPropagation();
        if(!this.uniformPopover) return;
        this.uniformPopover.el.querySelectorAll('button.hide').forEach(el => el.classList.remove('hide'));
        var button = this.uniformPopover.el.querySelector('.uniformSelect-show-all');
