...
export default class Tooltip extends Component {
    ...
    show () {
        ...
        this.listenToOnce(this.popup, 'transitionend', endTransition);
        this.listenToOnce(this.popup, 'msTransitionEnd', endTransition);
        this.listenToOnce(this.popup, 'oTransitionEnd', endTransition);
