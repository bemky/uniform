...
export default class Popover extends Component {
    ...
    setPosition(align){
        ...
        var offset = offset(this.options.anchor);
        ...
        if(leftAlign == 'left'){
            ...
            position.left = offset.left + outerWidth(this.options.anchor) / 2 - outerWidth(this.el) / 2;
        } else if (leftAlign == 'right'){
            position.left = offset.left + outerWidth(this.options.anchor);
        ...
        if(topAlign == 'top'){
            ...
            position.top = offset.top + outerHeight(this.options.anchor) / 2;
            position.transform = "translateY(-50%)";
        } else if (topAlign == 'bottom'){
            position.top = offset.top + outerHeight(this.options.anchor);
