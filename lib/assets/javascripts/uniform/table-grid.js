...
export default class Table extends Component {
    ...
    getSettings () {
        const settings = Object.assign(this.defaultSettings(), this.readSettings())
        ...
        Object.values(this.columnModels).forEach(model => {
            if (model.static && !settings.columns.find(x => x.id == model.id)) {
    ...
    saveSettings (settings) {
        if (!settings) settings = {columns: this.columns};
